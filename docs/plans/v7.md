...
See [`docs/plans/v1.md`](v1.md) → [`docs/plans/v6.md`](v6.md) for the prior
structure this mirrors, and [`docs/plans/tracking.md`](tracking.md) §7–§8
...
a themed release. [`docs/plans/tracking.md`](tracking.md) is expected to be
