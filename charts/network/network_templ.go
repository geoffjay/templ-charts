...
// Network renders a complete force-directed network SVG: dimensions →
// UseNetwork (force simulation) → links + nodes → SvgWrapper. Mirrors
// @nivo/network. Static render; per-node hover tooltips via Interactive.
func Network(props NetworkProps) templ.Component {
