...
func WaffleCellShape(props WaffleCellShapeProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 49, Col: 15}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 50, Col: 15}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 52, Col: 34}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 53, Col: 16}
		}
		...
		if props.BorderRadius > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 56, Col: 32}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 57, Col: 32}
			}
		...
		if props.BorderWidth > 0 && c.BorderColor != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 60, Col: 25}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 61, Col: 41}
			}
		...
		if props.Tooltip != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/waffle/waffle.templ`, Line: 64, Col: 34}
			}
