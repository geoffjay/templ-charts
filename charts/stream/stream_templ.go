...
// Static render (the interactive slices/dots layers arrive with the charts/interact
// client layer).
func Stream(props StreamProps) templ.Component {
