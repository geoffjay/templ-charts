...
func HeatMapCell(props HeatMapCellProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 57, Col: 31}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 58, Col: 32}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 60, Col: 35}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 61, Col: 17}
		}
		...
		if props.BorderRadius > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 64, Col: 33}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 65, Col: 33}
			}
		...
		if props.BorderWidth > 0 && c.BorderColor != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 68, Col: 26}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 69, Col: 42}
			}
		...
		if props.HxGet != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 72, Col: 24}
			}
		...
		if props.HxTrigger != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 75, Col: 32}
			}
		...
		if props.HxSwap != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 78, Col: 26}
			}
		...
		if props.HxTarget != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 81, Col: 30}
			}
		...
		if props.Tooltip != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 84, Col: 35}
			}
		...
		if props.EnableLabel && c.Label != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 90, Col: 20}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 91, Col: 20}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 94, Col: 27}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 96, Col: 13}
			}
