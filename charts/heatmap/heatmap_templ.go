...
func HeatMapCell(props HeatMapCellProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 51, Col: 31}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 52, Col: 32}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 54, Col: 35}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 55, Col: 17}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 56, Col: 33}
		}
		...
		if props.BorderRadius > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 58, Col: 33}
			}
		...
		if props.BorderWidth > 0 && c.BorderColor != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 62, Col: 26}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 63, Col: 42}
			}
		...
		if props.HxGet != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 66, Col: 24}
			}
		...
		if props.HxTrigger != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 69, Col: 32}
			}
		...
		if props.HxTarget != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 75, Col: 30}
			}
		...
		if props.EnableLabel && c.Label != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 80, Col: 20}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 84, Col: 27}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `charts/heatmap/heatmap.templ`, Line: 86, Col: 13}
			}
