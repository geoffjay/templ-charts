...
var lineTestCurves = []struct {
	...
	{"bumpX", CurveBumpX, "M0,0C5,0,5,20,10,20C15,20,15,10,20,10C25,10,25,40,30,40C35,40,35,30,40,30"},
	{"bumpY", CurveBumpY, "M0,0C0,10,10,10,10,20C10,15,20,15,20,10C20,25,30,25,30,40C30,35,40,35,40,30"},
}
